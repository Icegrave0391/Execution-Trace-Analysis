...
### Static Taint
- Arbiter: Bridging the Static and Dynamic Divide in Vulnerability Discovery on Binary Programs. J Vadayath, et al. Security'2022 [paper](https://www.usenix.org/system/files/sec22fall_vadayath.pdf)
